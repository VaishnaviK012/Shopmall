...
function Benifitsofbuilding() {
  ...
  return (
    <div className=' parent bg-black text-white mt-5'>
      <div className='pt-5 sm:ml-12'>
        <h3 className='md:pl-44 pl-2 md:text-4xl'>The benefits of building with 10Web</h3>
        <p className='sm:text-2xl mt-4 md:pl-44 pl-2'>
          Quickly launch a professional shopping mall website without coding. Benefit from AI tools, fastest and fully
          automated hosting powered by Google Cloud, top-notch security, scalable features, dedicated support, and more,
          all at a cost-effective price.
        </p>
      </div>

      {/* Grid section with 2 columns */}
      <div className='grid sm:mr-10 md:grid-cols-2 sm:grid-cols-1 gap-6 sm:ml-10 mt-10'>
        <div className=''>
          <div className="max-w-2xl mx-auto">
            ...
            <div className="border-b border-gray-200 dark:border-gray-700">
              ...
              {activeIndex === 1 && (
                <div className="p-5 border-t-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                  <p className="mb-2 sm:text-2xl text-gray-500 dark:text-gray-400">
                    No need to worry about hosting downtimes and technical maintenance again. With 99.9% uptime and elastic
                    scaling, your websites will be up and running at all times, so you can focus on other tasks.
                  </p>
                </div>
              )}
            </div>
            ...
            {/* Accordion Section 2 */}
            <div className="border-b sm:pt-5 border-gray-200 dark:border-gray-700">
              <h2>
                <button
                  type="button"
                  onClick={() => toggleAccordion(2)}
              ...
              {activeIndex === 2 && (
                <div className="p-5 border-t-0 border-gray-200 dark:border-gray-700">
                  <p className="mb-2 sm:text-2xl text-gray-500 dark:text-gray-400">
                    Automatically optimize the frontend speed of your website and get a 90+ PageSpeed score, improved Core Web
                    Vitals, 50% faster load times, higher rankings on Google, and better website performance.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="border-b sm:pt-5  border-gray-200 dark:border-gray-700">
              ...
              {activeIndex === 3 && (
                <div className="p-5 border-t-0 border-gray-200 dark:border-gray-700">
                  <p className="mb-2 sm:text-2xl text-gray-500 dark:text-gray-400">
                    Use Cloudflare's global CDN to serve your website to users at lightning speed from any part of the world.
                    Enjoy a smoother user experience with minimal latency.
                  </p>
                </div>
              )}
            </div>
        ...
        {/* Video Section */}
        <div className="mt-10 sm:mr-5 sm:mt-0 flex justify-center">
          <video
            className="w-full max-w-4xl h-auto rounded-lg shadow-lg"
            controls
            autoPlay
